...
const caregiverActionPlanSchema = new mongoose.Schema(
  {
    ...
    recommendationCode: { type: String, default: null },
    recommendationParams: { type: mongoose.Schema.Types.Mixed, default: null },
    reasonCode: { type: String, default: null },
    reasonParams: { type: mongoose.Schema.Types.Mixed, default: null },
    reasonSuffixCode: { type: String, default: null },
